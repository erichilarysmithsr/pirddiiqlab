...
# - The meal provider is "Pacific Gardens Mission Shelter for SNAP Office at 1112 South Wabash in Chicago"
...
print("Meal provider: Pacific Gardens Mission Shelter for SNAP Office at 1112 South Wabash in Chicago")
